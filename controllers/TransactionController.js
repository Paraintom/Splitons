...
angular.module('splitonsApp').controller('TransactionController', [
    '$scope', '$routeParams', '$location', 'projectsFactory', 'currenciesFactory',
    function ($scope, $routeParams, $location, projectsFactory, currenciesFactory) {
        ...
        function getTransaction(project, transactionId) {
            ...
            var existing = orderedResults.where(function (o) {
