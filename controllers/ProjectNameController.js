...
angular.module('splitonsApp').controller('ProjectNameController', [
    '$scope', '$project', 'projectsFactory', function ($scope, $project, projectsFactory) {
...
//# sourceMappingURL=ProjectNameController.js.map
