...
angular.module('splitonsApp').controller('SynchronizeController', ['$scope', '$routeParams', 'projectsFactory', 'synchFactory', 'notify', '$timeout', '$location', '$window', function ($scope, $routeParams, projectsFactory, synchFactory, notify, $timeout, $location, $window) {
