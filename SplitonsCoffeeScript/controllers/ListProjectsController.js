...
///<reference path="../external/bootbox.d.ts"/>
angular.module('splitonsApp').controller('ListProjectsController', [
    '$scope', 'projectsFactory', 'synchFactory', '$location', '$route', '$window',
    function ($scope, projectsFactory, synchFactory, $location, $route, $window) {
        ...
        $scope.sendViaFastFlicker = function (projectName, projectId) {
            ...
            sharer.onError().subscribe(function (err) {
                return console.log("Sharer error : " + err);
            });
