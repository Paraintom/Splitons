...
var ShareViaFastFlicker = (function () {
    ...
    ShareViaFastFlicker.prototype.share = function (projectId, projectName, passphrase) {
        ...
        if (navigator.onLine) {
            ...
            serviceLookup.onError().subscribe(function (a) {
                return _this.onLookupError(a);
            });

            var whenReadyMethod;
            serviceLookup.onResult().subscribe(function (ipAndPort) {
                whenReadyMethod = function (ff) {
                    return _this.whenReadySharing(ff, projectId, projectName, ipAndPort, passphrase, 0);
                };
    ...
    ShareViaFastFlicker.prototype.receive = function (passphrase) {
        ...
        if (navigator.onLine) {
            ...
            serviceLookup.onResult().subscribe(function (ipAndPort) {
                whenReadyMethod = function (ff) {
                    return console.debug('Connection open for ' + passphrase);
                };
                _this.onLookupSuccess(ipAndPort, passphrase, whenReadyMethod);
            });
            serviceLookup.getService("FastFlicker");
    ...
    ShareViaFastFlicker.prototype.onLookupSuccess = function (ipAndPort, passphrase, onReadyLogic) {
        ...
        this.fastFlicker.onMessage().subscribe(function (a) {
            return _this.handleAnswer(a);
        });
        this.fastFlicker.onError().subscribe(function (a) {
            return _this.handleError(a);
        });
    ...
    ShareViaFastFlicker.prototype.whenReadySharing = function (fastFlicker, projectId, projectName, ipAndPort, passphrase, numberTry) {
        ...
        if (numberTry != 3) {
            ...
            setTimeout(function () {
                var whenReadyMethod;
                whenReadyMethod = function (ff) {
                    return _this.whenReadySharing(ff, projectId, projectName, ipAndPort, passphrase, numberTry);
                };
                _this.onLookupSuccess(ipAndPort, passphrase, whenReadyMethod);
            }, 5000);
        }
